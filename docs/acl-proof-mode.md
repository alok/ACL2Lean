...
1. Extend the dynamic replay executors beyond `acl2_use` / `acl2_use_instance` / `acl2_induct_term`, especially for checkpoint-local splits, theory disables, and `:EXPAND`.
